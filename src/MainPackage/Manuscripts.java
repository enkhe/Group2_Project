...
public class Manuscripts {
	...
	private LinkedList<Manuscript> manuscripts;
	...
	public Manuscripts() {
		...
		manuscripts = new LinkedList<>();
	}

	public void addUserRole(Integer userID, User userRole) {
		// A single registered user can be Subprogram chair on multiple
		// conferences.
	...
	public LinkedList<Manuscript> getManuscripts() {
		return manuscripts;
	}

	public void setManuscripts(LinkedList<Manuscript> manuscripts) {
